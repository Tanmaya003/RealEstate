...
export default function UpdateListing() {
    ...
    // console.log(Loading)
    // console.log(error)
    useEffect(()=>{     //since the useEffect is async behaviour we can not call the useffect main function async so for any async functionality We have to create a new asynchronous function inside.
          ...
          <form className="flex flex-col sm:flex-row gap-5" onSubmit={handleSubmit}>
            ...
            <div className="flex flex-col flex-1 gap-4">
              ...
              <button
                ...
                >
                {Loading?"Updating List...":'Update Listing'}
              </button>
